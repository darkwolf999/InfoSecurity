...
{
    public class AES128 : IEncryptionDecryption
    {
        #region fields
        ...
        public AES128(Stream inputKey) 
        { 
            StreamReader sReader = new StreamReader(inputKey);
            key = sReader.ReadToEnd(); 
        }
        ...
        public void Encrypt(Stream input, Stream output)
        {
            ...
            String plaintext = sReader.ReadToEnd();
            ...
            byte[] byteArr = Encoding.ASCII.GetBytes(StateToString());
